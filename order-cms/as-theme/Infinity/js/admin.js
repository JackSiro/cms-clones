$(document).ready(function(){
	// tabs
		jQuery('.option-tabs li:first-child').addClass('active');
		jQuery('.option-tabs li a').click(function(e){
			e.preventDefault();
			jQuery('.option-tabs li').removeClass('active');
			jQuery(this).parent().addClass('active');
			var t = jQuery(this).data('toggle');
			jQuery('[class^="as-part-form-tc-"]').hide();
			jQuery(t).show();
	...
	$("#logo_uploader").uploadFile({
		...
		{
			$("#it_logo_field").val(it_featured_url_abs + data);
			$("#logo-preview").attr("src",it_featured_url_abs+data);
			$("#logo-preview").show();
		},
	...
	$("#favicon_uploader").uploadFile({
		...
		onSuccess:function(files,data,xhr)
		{
			$("#it_favicon_field").val(it_featured_url_abs + data);
			$("#favicon-preview").attr("src",it_featured_url_abs + data);
	...
	$('.option-tabs').on('click', function(e){
		scroll_check();
	});
	
	// Styling
	$( "#it_bg_select" ).change(function() {
		if ($( "#it_bg_select" ).val()=='bg_color')
			$( "#bg-color-container" ).show(500);
		else
			$( "#bg-color-container" ).hide(500);
	});
	$( "#it_enble_back_to_top" ).change(function() {
		$( "#back_to_top_location_container" ).toggle(500);
	});
	$( "#it_enable_adv_list" ).change(function() {
	...
	function build_advertisement_uploader(id){
		$("#adv_image_uploader_" + id).uploadFile({
			...
			onSuccess:function(files,data,xhr)
			{
				$("#adv_image_url_"+id).val(it_featured_url_abs + data);
				$("#adv_preview_"+id).attr("src",it_featured_url_abs+data);
	...
	$('#add_adv').on('click', function(e){
		...
		$("#ads_container").append('<tr id="adv_box_' + adv_count + '"><th class="as-form-tall-label th_' + adv_count + '">Advertisment #' + adv_count + '<span class="description">static advertisement</span></th><td class="as-form-tall-data"><div class="clearfix"></div><img id="adv_preview_' + adv_count + '" src="" class="adv-preview img-thumbnail" style="display:none;"><div class="clearfix"></div><div id="adv_image_uploader_' + adv_count + '">Upload Icon</div><input type="hidden" value="" id="social_image_url_' + adv_count + '" name="social_image_url_' + adv_count + '"><span class="description">Image Title</span><input class="as-form-tall-text" type="text" id="adv_image_title_' + adv_count + '" name="adv_image_title_' + adv_count + '" value=""><span class="description">Image link</span><input class="as-form-tall-text" id="adv_image_link_' + adv_count + '" name="adv_image_link_' + adv_count + '" type="text" value=""><span class="description">Display After this number of questions</span><select id="adv_location_' + adv_count + '" name="adv_location_' + adv_count + '" class="as-form-wide-select">' + list_options + '</select><button advid="' + adv_count + '" id="advremove" name="advremove" class="as-form-tall-button advremove pull-right btn" type="submit">Remove This Advertisement</button></td></tr>');
		$('html, body').animate({
	...
	$('#add_adsense').on('click', function(e){
		...
		adv_count =  Number($("#adv_number").val()) + 1;
		$("input[name=adv_number]").val(adv_count);
		$("#ads_container").append('<tr id="adv_box_' + adv_count + '"><th class="as-form-tall-label th_' + adv_count + '">Advertisment #' + adv_count + '<span class="description">Google Adsense Code</span></th><td class="as-form-tall-data"><input class="as-form-tall-text" id="adv_adsense_' + adv_count + '" name="adv_adsense_' + adv_count + '" type="text" value=""><span class="description">Display After this number of questions</span><select id="adv_location_' + adv_count + '" name="adv_location_' + adv_count + '" class="as-form-wide-select">' + list_options + '</select><button advid="' + adv_count + '" id="advremove" name="advremove" class="as-form-tall-button advremove pull-right btn" type="submit">Remove This Advertisement</button></td></tr>');    
		$('html, body').animate({
			scrollTop: $(".th_" + adv_count).offset().top
		}, 800);
	});
	...
	function build_social_uploader(id){
		$("#social_image_uploader_" + id).uploadFile({
			...
			onSuccess:function(files,data,xhr)
			{
				$("#social_image_url_"+id).val(it_featured_url_abs + data);
				$("#social_image_preview_"+id).attr("src",it_featured_url_abs+data);
	...
	$('#add_social').on('click', function(e){
		...
		$("#social_container").append('<tr id="social_box_' + social_list_count + '"><th class="as-form-tall-label social_th_' + social_list_count + '">Social Link #' + social_list_count + '<span class="description">choose Icon and link to your social profile</span></th><td class="as-form-tall-data"><span class="description">Social Profile Link</span><input class="as-form-tall-text" id="social_link_' + social_list_count + '" name="social_link_' + social_list_count + '" type="text" value=""><span class="description">Link Title</span><input class="as-form-tall-text" type="text" id="social_title_' + social_list_count + '" name="social_title_' + social_list_count + '" value=""><span class="description">Choose Social Icon</span><select id="social_icon_' + social_list_count + '" name="social_icon_' + social_list_count + '" fieldid="' + social_list_count + '" class="as-form-wide-select social-select">' + list_options + '</select><div class="social_icon_file_' + social_list_count + '"><span class="description">upload Social Icon</span><img id="social_image_preview_' + social_list_count + '" src="" class="social-preview img-thumbnail" style="display:none;"><div id="social_image_uploader_' + social_list_count + '">Upload Icon</div><input type="hidden" value="" id="social_image_url_' + social_list_count + '" name="social_image_url_' + social_list_count + '"><button advid="' + social_list_count + '" id="social_remove" name="social_remove" class="as-form-tall-button social_remove pull-right btn" type="submit">Remove This Link</button></td></tr>');
		$('html, body').animate({
